namespace Ordering.Application.Orders.Commands.UpdateOrder
{
    ...
    {
        async Task<UpdateOrderResult> IRequestHandler<UpdateOrderCommand, UpdateOrderResult>.Handle(UpdateOrderCommand command, CancellationToken cancellationToken)
        {
